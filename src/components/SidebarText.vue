<template>
  <div class="sidebar-text">
    <div class="sidebar-card-header">
      ...
      <div class="sidebar-card-header__title">Управление текстом</div>
    ...
    <div class="sidebar-text__input">
      <textarea v-model="text" @keyup.prevent="updateInput" placeholder="Ваш текст..."></textarea>
    </div>
    <div class="sidebar-text__tools">
      ...
      <button
        @click="setTextAlignment(TextAlignment.START)"
        :disabled="!isMultiLine"
        class="sidebar-text__tools-item"
        :class="{'active': isTextAlignment(TextAlignment.START) && isMultiLine}"
      >
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 409.294 409.294">
          <path
            id="path-1_357_"
            d="m0 116.941h292.353v58.471h-292.353z"
            transform="translate(1 5)"
          />
          <path id="path-2_27_" d="m0 233.882h409.294v58.471h-409.294z" transform="translate(1 9)" />
          <path
            id="path-1_356_"
            d="m0 350.824h292.353v58.471h-292.353z"
      ...
      <button
        @click="setTextAlignment(TextAlignment.MIDDLE)"
        :disabled="!isMultiLine"
        class="sidebar-text__tools-item"
        :class="{'active': isTextAlignment(TextAlignment.MIDDLE) && isMultiLine}"
      >
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 409.294 409.294">
          <path
            id="path-1"
            d="m58.471 116.941h292.353v58.471h-292.353z"
            transform="translate(3 5)"
          />
          <path id="path-2" d="m0 233.882h409.294v58.471h-409.294z" transform="translate(1 9)" />
          <path
            id="path-1_1_"
            d="m58.471 350.824h292.353v58.471h-292.353z"
      ...
      <button
        @click="setTextAlignment(TextAlignment.END)"
        :disabled="!isMultiLine"
        class="sidebar-text__tools-item"
        :class="{'active': isTextAlignment(TextAlignment.END) && isMultiLine}"
      >
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 409.294 409.294">
          <path
            id="path-1_5_"
            d="m116.941 116.941h292.353v58.471h-292.353z"
            transform="translate(5 5)"
          />
          <path id="path-2_5_" d="m0 233.882h409.294v58.471h-409.294z" transform="translate(1 9)" />
          <path
            id="path-1_4_"
            d="m116.941 350.824h292.353v58.471h-292.353z"
      ...
      <button
        @click="setTextAlignment(TextAlignment.JUSTIFIED)"
        :disabled="!isMultiLine"
        class="sidebar-text__tools-item"
        :class="{'active': isTextAlignment(TextAlignment.JUSTIFIED) && isMultiLine}"
      >
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 409.294 409.294">
    ...
    <div class="sidebar-text__layer-tools">
      ...
      <div class="sidebar-text__layer-tools-item" @click="moveLayerDown">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
          <path
            d="M142.9,369.1V512H512V142.9H369.1V0H0v369.1H142.9z M476.3,178.6v297.7H178.6V178.6L476.3,178.6L476.3,178.6z M35.7,35.7  h297.7v107.2H142.9v190.5H35.7L35.7,35.7L35.7,35.7z"
          />
          <rect
            x="53.9"
            y="-12.2"
            transform="matrix(0.7071 0.7071 -0.7071 0.7071 64.7976 -26.8357)"
            width="21.8"
            height="154.1"
          />
          <rect
            x="85.1"
            y="-25.5"
            transform="matrix(0.7071 0.7071 -0.7071 0.7071 99.4768 -38.2975)"
            width="21.8"
            height="252.9"
          />
          <rect
            x="118.5"
            y="-34.1"
            transform="matrix(0.7071 0.7071 -0.7071 0.7071 134.2797 -51.5417)"
            width="21.8"
            height="340.8"
          />
