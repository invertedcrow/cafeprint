    ...
    <div class="sidebar-price">
        <div class="sidebar-card-header">
            <div class="sidebar-card-header__с-icon">
                <svg xmlns:xlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg" version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 294.133 294.133" style="enable-background:new 0 0 294.133 294.133;" xml:space="preserve">
        ...
        <div class="sidebar-price__sizes">
            ...
            <ul class="sidebar-price__sizes-list">
                <li :key="index" v-for="(size, index) in sizes">
                    <span>{{size.label}}</span>
                    <number-input :min="0" v-model="size.value"></number-input>
                </li>
            </ul>
        </div>
