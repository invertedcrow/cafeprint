    ...
    <div class="sidebar-layers">
        <div class="sidebar-card-header">
            <div class="sidebar-card-header__с-icon">
                <svg xmlns:xlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg" version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 210.1 210.1" style="enable-background:new 0 0 210.1 210.1;" xml:space="preserve">
                    <path class="st0" d="M168.5,0H80.2C67.4,0,57,10.4,57,23.3v2.9H41.6c-12.8,0-23.3,10.4-23.3,23.3v137.5c0,12.8,10.4,23.3,23.3,23.3   h88.3c12.8,0,23.3-10.4,23.3-23.3V184h15.4c12.8,0,23.3-10.4,23.3-23.3V23.3C191.8,10.4,181.3,0,168.5,0z M176.8,160.7   c0,4.6-3.7,8.3-8.3,8.3h-15.4V49.4c0-12.8-10.4-23.3-23.3-23.3H72v-2.9c0-4.6,3.7-8.3,8.3-8.3h88.3c4.6,0,8.3,3.7,8.3,8.3   L176.8,160.7L176.8,160.7z"/>
                </svg>
            </div>
        ...
        <div class="sidebar-layers__layers">
            <div :key="index" v-for="(side, index) in layers">
                <div class="sidebar-layers__side-head">
                    <div class="sidebar-layers__side-head__title">{{side.label}}</div>
                    <div class="sidebar-layers__side-head__tools">
                        <svg xmlns:xlink="http://www.w3.org/1999/xlink" class="replay" xmlns="http://www.w3.org/2000/svg" version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 76.398 76.398" style="enable-background:new 0 0 76.398 76.398;" xml:space="preserve">
                    ...
                    <svg xmlns:xlink="http://www.w3.org/1999/xlink" class="opposite" xmlns="http://www.w3.org/2000/svg" version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 472.774 472.774" style="enable-background:new 0 0 472.774 472.774;" xml:space="preserve">
                ...
                <div class="sidebar-layers__side-layer" :key="index" v-for="(layer, index) in side.items">
                    <div v-if="layer.type === 'text'">
                        <span class="sidebar-layers__side-layer__text-mark"><span>T</span></span>
                        <span class="sidebar-layers__side-layer__text">{{layer.text}}</span>
                    </div>
                    <img v-if="layer.type === 'image'" :src="layer.image">
                ...
                <div class="sidebar-layers__side-layer">
                </div>
            </div>
        </div>
    </div>
