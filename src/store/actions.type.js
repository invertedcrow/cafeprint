export const GET_BASES_CATEGORIES = "fetchCategories";
export const GET_BASES_LIST       = "fetchBases";
export const GET_BASE             = "fetchBase";
...
export const SAVE_UPDATE_ORDER_ITEM = "SAVE_UPDATE_ORDER_ITEM";
